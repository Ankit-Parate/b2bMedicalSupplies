...
<head>
  ...
  <title>Pharmacy Details Page</title>
          ...
          <h1 class="h3 mb-4 text-gray-800">Pharmacy Home Page</h1>
			...
			<!-- 
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <div class="dropdown">
                    	<select name="userType" class="btn btn-user btn-success btn-block dropdown-toggle "  id="userType">
                 ...
                 <div class="form-group col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pharId" id="username" placeholder="User Name">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control form-control-user" name="pharName" id="username" placeholder="User Name">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="password" class="form-control form-control-user" name="pharPass" id="password" placeholder="Password">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="password" class="form-control form-control-user" id="repeatPassword" placeholder="Repeat Password">
                  </div>
                <div class="form-group col-sm-6">
                  <input type="text" class="form-control form-control-user" name="pharAddress" id="address" placeholder="Address">
                </div>
                <!--
                <div class="form-group col-sm-6">
                  <input type="number" class="form-control form-control-user" name="pharPhoneNumber" id="phoneNumber" placeholder="Phone number">
                </div>
                 -->
                <div class="form-group col-sm-6">
                  <input type="email" class="form-control form-control-user"  aria-describedby="emailHelp" name="pharMailId" id="email" placeholder="Email Address">
                </div>
                <!--
                <div class="form-group">
                 ...
                 -->
                <input class="form-group col-sm-6 btn btn-primary btn-user btn-block" type="submit" value="Update Details">
                <!--
